...
public class ParkingManagerGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome to Parking Manager ");
        ...
        ViewParkingSpaceBtn.setForeground(new java.awt.Color(0, 51, 153));
        ViewParkingSpaceBtn.setText("View Parking Spaces");
        ...
        ManageBtn.setForeground(new java.awt.Color(0, 51, 153));
        ManageBtn.setText("Manage Vehicle");
        ...
        ExitBtn.setForeground(new java.awt.Color(0, 51, 153));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ParkingManagerGUI().setVisible(true));
    }
